...
- Goals:
    - Part 1: Teach you a very general way to translate statistical models back into substantive scientific questions.
...
- Given an underspecified research questions, many analysts will come up with many different estimates.

![](figures/many_analysts1.png)

## But what is the estimand?

- If we restrict to the estimates that are all consistent with a commmon estimand, much more agreement among analysts.

![](figures/many_analysts2.png)

----

## Many choices of estimand, more effort needed in science to connect theory to the quantities we report in our papers
